...
And to achieve our design principles from @sec-design, we also eventually (not
all at once) want to work towards a point where we:
...
- Use Zenodo to upload protocols (before submitting to other outlets), analysis
  code, and preprints
...
- Use Teamup, a calendar tool, for scheduling meetings and events relevant to
  all groups
