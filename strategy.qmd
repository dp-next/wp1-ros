...
technical or digital perspective. Many of these activities and strategies
...
-   Automating or streamlining data flows, from collected into stored,
    for rapid internal sharing of data outputs.
...
-   Study protocols that are the description of the research question,
    the methods used to answer the question, and the data that will be
    collected.
-   Data management plans, which are the description of how data will be
    collected, stored, and shared.
-   Statistical analysis plans, which are the description of how the
    data will be analysed.
-   Operational documents, like decisions made, procedures,
    collaboration agreements, and workflows for collaboration and work.
