...
-   The Green Open Access format (meaning to publish as a pre-print in an open archive such as [Zenodo](https://zenodo.org) or bioRxiv).
...
Author lists and orders will be established at the stage of definition of the synopsis / analysis protocol. All who have contributed to DP-Next who also qualify for co-authorship should be given the chance to become co-author on papers relating to data that they have helped collect or analyse. The Steering Committee will help to facilitate this by keeping an up to date list of submitted synopses so that those interested in contributing to the publication and being a co-author can signal their interest. Substantial contributions are a requirement for co-authorships. All potential co-authors must be involved early in the process of preparing the publications, ideally at the stage of the synopsis submission. In addition to the named authors, all papers should by default include the group authorship of 'on behalf of the DP-Next investigators', linking to the current list of [DP-Next investigators](https://dp-next.github.io/who-we-are.html)

Author lists and orders may be amended after synopsis approval by consensus among the authors or by the Steering Committee if the factual contributions differ from those foreseen initially.

If disagreements about authorship cannot be resolved by consensus within the author group, the Steering Committee will make a decision. Regardless of named authors, publications will include detailed contributor lists along with described contributions as per the [CRediT roles](https://credit.niso.org), either directly in the paper, as a supplemental appendix, or described on an external publicly accessible document. The Steering Committee will ensure that such a document is publicly accessible and up to date. Furthermore, papers must include an acknowledgment to external parties such as funders, institutions, participants, and service providers that have contributed to the specific work presented in each paper. The Steering Committee will maintain an updated acknowledgment statement for the DP-Next project.
...
1.  Creation of a publicly accessible repository specifically for each publication on GitHub. The repository must be placed under the DP-Next organization, be named according to the [naming guide](/design/naming.qmd) and use our template. This repository will contain the various 'sub-products' described below as separate 'chapters'.
...
10. Publication. The authors should send a copy of the full text of a publication and/or a link to the final materials to the Steering Committee and report/log the activity on the relevant academic output tracking platform.
